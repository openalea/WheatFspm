...
class MorphogenesisFacade(object):
    ...
    def __init__(self, shared_mtg, delta_t,
                 ...
                 update_parameters=None, update_shared_df=True, explicit_tillers=False):
        """
        ...
        :param bool explicit_tillers: if True, compute real elongation kinetics for every tiller axis instead of
            mirroring the main stem's geometry onto them.
        """
        ...
        self._simulation = simulation.Simulation(delta_t=delta_t, hydraulics=hydraulics, optimal_growth_option=optimal_growth_option,
                                                 update_parameters=update_parameters, explicit_tillers=explicit_tillers)  #: the simulator to use to run the model
