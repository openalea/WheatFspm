...
def test_calculate_respiwheat():
    ...
    actual_respirations['R_phloem'] =  model.RespirationModel.R_phloem(sucrose_loading, mstruct)[0]
    ...
    actual_respirations['R_residual'] =  model.RespirationModel.R_residual(sucrose, mstruct, Ntot, Ts)[0]
