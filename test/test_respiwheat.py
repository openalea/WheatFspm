...
def test_calculate_respiwheat():
    ...
    actual_respirations = {'R_growth': model.RespirationModel.R_growth(mstruct_growth),
                           'R_grain_growth_struct': model.RespirationModel.R_grain_growth(mstruct_growth, starch_filling, mstruct)[0],
                           'R_grain_growth_starch': model.RespirationModel.R_grain_growth(mstruct_growth, starch_filling, mstruct)[1],
                           'R_phloem': model.RespirationModel.R_phloem(sucrose_loading, mstruct)[0],
                           'R_Namm': model.RespirationModel.R_Namm_upt(U_Namm),
                           'R_Nnit': model.RespirationModel.R_Nnit_upt(U_Nnit, sucrose),
                           'R_Nnit_red_shoot': model.RespirationModel.R_Nnit_red(s_amino_acids, sucrose, mstruct)[0],
                           'R_Nnit_red_roots': model.RespirationModel.R_Nnit_red(s_amino_acids, sucrose, mstruct, root=True)[0],
                           'R_N2fix': model.RespirationModel.R_N2fix(I_Nfix),
                           'R_min_upt': model.RespirationModel.R_min_upt(delta_BMstruct),
                           'R_residual': model.RespirationModel.R_residual(sucrose, mstruct, Ntot, Ts)[0]}
